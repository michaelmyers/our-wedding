            ...
            <span>
                ...
                <Row center>
                    <Col percentage={60}>
                        ...
                        <p><span className={style.time}>8:00 PM</span> - Join the bride and groom for a drink & appetizers on them.</p>
                ...
                <Row center>
                    <Col percentage={60}>
                        ...
                        <p>Tunnicliff's Tavern, across the street from Eastern Market, is a favorite spot for Annie, Michael and friends.  If you are in town, join them the night before the wedding a drink and appetizers on them.</p>
                        ...
                        <p>Built in 1873, Eastern Market serves the Capitol Hill neighborhood of D.C. as a public market.  It was included in L'Enfant's original 1791 plan for Washington, D.C. (along with a Central Market and Western Market) and is the only remaining market building that still functions as a market.  Listed on the National Register of Historic Places, it is the center of Annie and Michael's community in D.C. - visiting the market to pick up groceries or sunflowers is a common weekend activity.</p>
                ...
                <Row center>
                    <Col percentage={60}>
                        ...
                        <p>After we say our vows to each other, we invite you — our community of family and friends — to share messages with us.  All are welcome to contribute a thought or reading that reflects the joy and significance of this occasion.</p>
                        <p>If you are interested in speaking, please plan to keep your message to a few minutes or less, so that all those who would like to participate may have a chance.  You can expect some pauses or moments of silence at this point in the ceremony; we welcome these as opportunities for reflection.</p>
                    </Col>
                </Row>
                <Row center>
                    <Col percentage={40}>
                ...
                <Row center>
                    <Col percentage={60}>
                        <h3 id="band">Band</h3>
                        <p>Live music will be provided by Dr. Blues' <a href="http://newvegasloungedc.com/band/">Out of Town Blues Band</a>, a 7-peice rythm and blues band.  The band plays out of the New Vegas Lounge, one of Washington, D.C. best clubs for live music and a favorite spot of Michael and Annie.</p>
                    </Col>
                </Row>
            </span>
        );
